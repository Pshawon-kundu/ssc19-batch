              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8 space-y-6">
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={handleBackStep}
                    className="flex-none px-5 py-3.5 border-2 border-emerald-500 text-emerald-700 rounded-xl font-semibold text-sm hover:bg-emerald-50 active:bg-emerald-100 transition-all flex items-center gap-1.5"
                  >
